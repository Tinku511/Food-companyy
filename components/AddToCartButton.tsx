        ...
        className={`relative flex w-full items-center justify-center gap-2.5 overflow-hidden rounded-full py-4 text-sm font-semibold transition-all duration-300 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-brass focus-visible:ring-offset-2
          ${outOfStock || isLoading
            ...
            : added
              ...
              : 'bg-gradient-to-r from-yellow-400 to-orange-400 text-charcoal shadow-lg shadow-brass/30 hover:shadow-brass/50 hover:-translate-y-0.5 active:translate-y-0'
          }`}
      >
        {outOfStock ? (
          <>
          ...
          <>
            <svg className="h-5 w-5 animate-[scale-in_0.3s_ease-out]" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
