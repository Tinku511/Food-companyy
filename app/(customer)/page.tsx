...
const categories = [
  { name: 'Snacks',    image: 'https://images.unsplash.com/photo-1599490659213-e2b9527bd087?w=600&q=80', desc: 'Healthy guilt-free munching' },
  { name: 'Beverages', image: 'https://images.unsplash.com/photo-1513558161293-cdaf765ed2fd?w=600&q=80', desc: 'Refresh with natural goodness' },
  { name: 'Dairy',     image: 'https://images.unsplash.com/photo-1628088062854-d1870b4553da?w=600&q=80', desc: 'Farm-fresh dairy products' },
  { name: 'Bakery',    image: 'https://images.unsplash.com/photo-1509440159596-0249088772ff?w=600&q=80', desc: 'Freshly baked every morning' },
];
...
export default async function HomePage() {
  ...
  return (
    <>
      ...
      <section id="hero" className="relative flex min-h-[90vh] items-stretch animate-fade-in" aria-label="Hero banner">
        <div className="flex w-full flex-col lg:flex-row">
          ...
          <div className="flex w-full flex-col justify-center bg-background px-6 py-20 lg:w-5/12 lg:px-16 xl:px-24">
            <div className="max-w-xl">
              ...
              <h1 className="text-5xl font-bold leading-[1.1] tracking-tight text-charcoal sm:text-6xl lg:text-7xl text-balance font-display">
                Pure food,<br/>
                honest roots.
              </h1>
              <p className="mt-8 text-lg leading-relaxed text-stone-600 text-balance">
                We believe in the power of natural, farm-sourced ingredients. Discover a curated selection of whole foods crafted to nourish your body and delight your senses.
              </p>
          ...
          <div className="relative min-h-[50vh] w-full lg:w-7/12">
            <div className="absolute inset-0 bg-stone-900/10 z-10" /> {/* Subtle gradient overlay for mood */}
            <Image
      ...
      <section id="featured-products" className="py-12" aria-label="Featured products">
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <div className="mb-16 text-center">
            ...
            <p className="section-subtitle mx-auto">Seasonal highlights and customer favorites, hand-picked for you.</p>
          </div>

          {featured.length > 0 ? (
            <div className="-mx-4 flex gap-6 overflow-x-auto px-4 pb-8 snap-x snap-mandatory sm:mx-0 sm:px-0 [&::-webkit-scrollbar]:hidden [-ms-overflow-style:none] [scrollbar-width:none]">
              {featured.map((product) => (
                <div key={product.id} className="w-[85vw] shrink-0 snap-start sm:w-[320px] lg:w-[calc(25%-1.125rem)]">
            ...
            <div className="py-24 text-center">
              <p className="text-sm text-stone-500 font-serif italic">No products available at the moment.</p>
            </div>
          )}
      ...
      <section id="categories" className="py-12" aria-label="Product categories">
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <div className="mb-16 max-w-2xl">
            ...
            <p className="section-subtitle">Explore our diverse range of natural offerings, organized for your convenience.</p>
          </div>
            ...
            {categories.map((cat) => (
              ...
              >
                ...
                <div className="relative z-10 p-6">
                  ...
                  <p className="mt-2 text-sm text-stone-200 opacity-0 transition-all duration-300 group-hover:opacity-100 group-hover:translate-y-0 translate-y-2">
                    {cat.desc}
                  </p>
                </div>
              </Link>
      ...
      <section id="our-story" className="py-24" aria-label="Our Story">
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <div className="relative flex flex-col items-center lg:flex-row lg:items-start">
            <div className="relative h-[500px] w-full lg:w-[55%] shrink-0 rounded-3xl overflow-hidden shadow-card">
              <Image 
            ...
            <div className="relative -mt-20 w-[90%] lg:mt-24 lg:-ml-16 lg:w-[45%] bg-background p-8 sm:p-12 shadow-2xl border border-stone-100 rounded-3xl">
              <span className="font-mono text-xs uppercase tracking-widest text-brass">Our Story</span>
              <h2 className="font-display text-4xl mt-4 text-charcoal font-bold">Rooted in passion, grown with care.</h2>
              <p className="mt-6 text-stone-600 leading-relaxed">
                It started with a simple belief: food should be honest. We traveled across the country connecting directly with farmers who share our obsessive standards for natural cultivation. 
              </p>
              <p className="mt-4 text-stone-600 leading-relaxed">
                Today, every product on our shelves tells a story of sustainable agriculture and uncompromised quality. We bring the harvest directly to your table—just as nature intended.
              </p>
              <div className="mt-8">
                <span className="font-display text-2xl italic text-brass">Maria Rossi</span>
                <span className="block text-xs text-stone-400 mt-1 uppercase tracking-widest">Founder & Curator</span>
              </div>
            </div>
          </div>
        </div>
              ...
              <div className="flex flex-col gap-12">
                {features.map((f, i) => (
                  <div key={f.title} className="flex gap-6">
                    ...
                    <div>
                      <h3 className="text-xl font-bold text-charcoal font-display">{f.title}</h3>
      ...
      {/* ─── CTA BANNER ───────────────────────────────────────────────── */}
      <section id="cta-banner" className="relative mt-20 bg-charcoal py-32 text-center" aria-label="Call to action">
        ...
        <div className="relative z-10 mx-auto max-w-2xl px-4">
          ...
          <div className="mt-10 flex flex-wrap items-center justify-center gap-4">
            <Link href="/products" id="cta-shop-now" className="btn-primary px-10 py-4 text-base shadow-brand-lg">
              Start Shopping
            </Link>
