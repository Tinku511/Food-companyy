...
function getCategoryMeta(cat: string) {
  return categoryColors[cat] ?? { pill: 'bg-stone-100 text-stone-600 border-stone-200', icon: '🛒' };
}
      ...
      <div className="border-b border-stone-200 bg-white">
        <div className="mx-auto max-w-7xl px-4 py-4 sm:px-6 lg:px-8">
          <nav className="flex items-center gap-2 text-sm text-stone-500" aria-label="Breadcrumb">
            ...
            <Link href="/products" className="transition hover:text-brass">Products</Link>
            <span className="text-stone-300">/</span>
        ...
        <div className="grid gap-12 lg:grid-cols-2">
          ...
          <div className="animate-slide-up flex flex-col gap-6">
            ...
            <div className="flex flex-wrap items-center gap-3">
              <span className={`inline-flex items-center gap-1.5 rounded-full border px-3 py-1 text-xs font-semibold ${catMeta.pill}`}>
            ...
            {/* Product name */}
            <h1 className="text-3xl font-bold leading-tight text-charcoal sm:text-4xl text-balance">
              {product.name}
            </h1>
