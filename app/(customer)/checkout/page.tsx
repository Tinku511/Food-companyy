      ...
      <div className="mb-12">
        ...
        <div className="mb-10 flex items-center justify-center gap-4">
          <Link href="/cart" className="group flex items-center gap-2">
            <span className="text-xs font-bold uppercase tracking-widest text-stone-400 transition-colors group-hover:text-brass">
              Cart
            </span>
          </Link>
        ...
        <div className="text-center">
          ...
          <p className="mt-2 text-stone-500">
            Fill in your address, then we&apos;ll take you to payment
          </p>
        </div>
      </div>
          ...
          <div className="space-y-8 lg:col-span-7">
            ...
            <div className="card p-6 sm:p-8">
              <div className="mb-6 flex items-center gap-3">
                <span className="flex h-8 w-8 items-center justify-center rounded-full bg-brass/10 text-sm font-bold text-brass">
                  1
                </span>
            ...
            <div className="card p-6 sm:p-8">
              ...
              <p className="max-w-md text-sm leading-relaxed text-stone-500">
                Your payment will be processed securely through Razorpay. All major UPI,
                Credit/Debit cards, and Net Banking methods are accepted.
              </p>
